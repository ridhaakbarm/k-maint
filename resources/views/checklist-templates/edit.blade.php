                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('inspection_condition') is-invalid @enderror" name="inspection_condition" required>
                            ...
                            <option value="Running" {{ old('inspection_condition', $checklistTemplate->inspection_condition) === 'Running' ? 'selected' : '' }}>Running</option>
                            <option value="Off" {{ old('inspection_condition', $checklistTemplate->inspection_condition) === 'Off' ? 'selected' : '' }}>Off</option>
                            <option value="Running / Off" {{ old('inspection_condition', $checklistTemplate->inspection_condition) === 'Running / Off' ? 'selected' : '' }}>Running / Off</option>
                        </select>
